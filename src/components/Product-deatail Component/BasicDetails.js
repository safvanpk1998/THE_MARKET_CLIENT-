...
import { createNewWishList, clearWishListError } from "../../slices/wishListSlice";
...
function BasicDetails() {
  ...
  const { id } = useParams();
  const productDetail = useSelector((state) => state.productDetails.productDetails);
      ...
      <div className="header">
        ...
        <div className="add">
         ...
         <div className="cart-button">
           ...
           <Link to={`/product/productdetails/checkout/${id}/${count}`}> <Button>Buy</Button></Link>
          ...
          <div className="title-Screen">
            ...
            <div className="dealer">
              <p>
                ...
                <span className="name">    {data.stock>0?"In stock":"Out Of Stock"} </span>
              </p>
        ...
        <Tabs defaultActiveKey="1">
          ...
          <Tabs.TabPane tab="Vendor Info" key="4">
            ...
            <div className="vendor">
              ...
              <p>
                {" "}
                <span className="criteria"> Address: </span> 335 Orchard , Navi
                Mumbai
              </p>
