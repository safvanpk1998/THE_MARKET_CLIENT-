...
function Buy() {
  ...
  const{singleProduct, productDetails }= useSelector((state) => state.productDetails);
  const { loading, err,ordercreated, order } = useSelector((state) => state.order);
